...
export const Route = createFileRoute('/(app)/create-portfolio/metadata')({
...
function PortfolioInfo() {
  const { mutate, isPending } = useCreateDraftPortfolio();
    ...
    <form onSubmit={form.onSubmit(handleSubmit)}>
      <Stack h="80vh" justify="space-between">
        ...
        <Group justify="flex-end">
          <CustomButtonLink to="/dashboard" variant="outline" disabled={isPending}>
            Cancel
          </CustomButtonLink>
